package com.example.enter_names.libraries;
...
import com.example.enter_names.R;
...
public class DialogFragmentHelper extends DialogFragment {
    ...
    protected void _openDialogFragment(DialogFragment f,String id) {
        f.show(_pActivity.getSupportFragmentManager(), id);
    }
}